...
// https://discourse.mc-stan.org/t/rejecting-initial-value-chain-1-log-probability-evaluates-to-log-0-i-e-negative-infinity/17866/3
    ...
    sigma_topic_women ~ exponential(1.0/ideal_sigma);
    sigma_topic_men ~ exponential(1.0/ideal_sigma);
    sigma_nontopic_men ~ exponential(1.0/ideal_sigma);
    sigma_nontopic_women ~ exponential(1.0/ideal_sigma);

//vectorised over TOPICS
    popularity_topic_women ~ normal(0, sigma_topic_women);
    popularity_topic_men ~ normal(0, sigma_topic_men);
...
// vectorised over COHORTS
    ...
    for(cohort in 1:COHORTS){
        popularity_module_topic_women[cohort] = module_topics[cohort] * popularity_topic_women;
        popularity_module_topic_men[cohort] = module_topics[cohort] * popularity_topic_men;
